...
GetLastError = cast(Callable[[], int], kernel32.GetLastError)
FALSE = 0
...
def _get_pid_data(pid: int) -> _PidData | None:
    ...
    try:
        ...
        if Process32First(process_snapshot, ctypes.byref(pe32)) == FALSE:
        ...
        while Process32Next(process_snapshot, ctypes.byref(pe32)) != FALSE:
